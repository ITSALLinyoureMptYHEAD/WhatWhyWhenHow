    ...
    if cmd_name == "echo":
        ...
        if len(parts) > 1:
            try:
                ...
                pass
        # Precise Spacing for CodeCrafters: 2 spaces, index, 2 spaces, command
...
def main():
    # Stage: Persistence - Read history on startup
    ...
    while True:
        ...
        # State-Changing builtins MUST run in Parent process
        if parts[0] == "cd":
            ...
            # Silent update for memory Persistence
